    ...
    <>
      ...
      >
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            className={`${styles.cardReset} ${styles.stagger_1}`}
            loading={loading}
          >
            ...
            <div className={styles.cardInfo}>
              ...
              <h2>
                ...
                {data &&
                  ...
                  digitFormat(data.orderStatistics.orderTotalAmount)}
              </h2>
            </div>
            <div className={styles.cardStats}>
              ...
              <p className={styles.value}>
                {ConstantUtil.CURRENCY}{" "}
                {data &&
                  data.currentMonthOrderStatistics &&
                  digitFormat(
                    data.currentMonthOrderStatistics.orderTotalAmount
                  )}
              </p>
            </div>
            <div className={styles.cardStats}>
              ...
              <p className={styles.value}>
                {ConstantUtil.CURRENCY}{" "}
                {data &&
                  data.lastMonthOrderStatistics &&
                  digitFormat(data.lastMonthOrderStatistics.orderTotalAmount)}
              </p>
            </div>
          </Card>
        </Col>
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            className={`${styles.cardReset} ${styles.stagger_2}`}
            loading={loading}
          >
        ...
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            className={`${styles.cardReset} ${styles.stagger_3}`}
            loading={loading}
          >
            ...
            <div className={styles.cardInfo}>
              ...
              <h2>
                ...
                {data &&
                  data.cartStatistics &&
                  digitFormat(data.cartStatistics.cartTotalAmount)}
              </h2>
            </div>
            <div className={styles.cardStats}>
              <p className={styles.cardDay}>This Month</p>
              ...
              <p className={styles.value}>
                {ConstantUtil.CURRENCY}{" "}
                {data &&
                  data.currentMonthCartStatistics &&
                  digitFormat(data.currentMonthCartStatistics.cartTotalAmount)}
              </p>
            </div>
            <div className={styles.cardStats}>
              <p className={styles.cardDay}>Last Month</p>
              ...
              <p className={styles.value}>
                {ConstantUtil.CURRENCY}{" "}
                {data &&
                  data.lastMonthCartStatistics &&
                  digitFormat(data.lastMonthCartStatistics.cartTotalAmount)}
              </p>
            </div>
          </Card>
        </Col>
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            className={`${styles.cardReset} ${styles.stagger_4}`}
            loading={loading}
          >
      ...
      >
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            bodyStyle={{ padding: 0 }}
            className={`${styles.cardReset} ${styles.stagger_5}`}
            loading={loading}
          >
        ...
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            bodyStyle={{ padding: 0 }}
            className={`${styles.cardReset} ${styles.stagger_6}`}
            loading={loading}
          >
            <div className={styles.cardDetails}>
        ...
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            bodyStyle={{ padding: 0 }}
            className={`${styles.cardReset} ${styles.stagger_7}`}
            loading={loading}
          >
            <div className={styles.cardDetails}>
        ...
        <Col lg={6} md={8} sm={24} xs={24} className={styles.mb2}>
          <Card
            bodyStyle={{ padding: 0 }}
            className={`${styles.cardReset} ${styles.stagger_8}`}
            loading={loading}
          >
            <div className={styles.cardDetails}>
      ...
      <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
        <Col lg={16} md={24} sm={24} xs={24} className={styles.mb2}>
          <Card
            className={`${styles.cardReset} ${styles.stagger_9}`}
            loading={loading}
          >
        ...
        <Col lg={8} md={12} sm={24} xs={24} className={styles.mb2}>
          <Card
            className={`${styles.cardReset} ${styles.stagger_10}`}
            loading={loading}
          >
            ...
            <p>
              ...
              <span className={styles.current}>Learn more</span>
            </p>
