        ...
        <div className="product">
          <Spin indicator={antIcon} spinning={loading}>
            <div className="product-card">
              <div className="cover">
                <img
                  src={checkPath(product.imageone)}
                  alt="product"
            ...
            <div className="product-card wide details">
              ...
              <div className="reviews">
                ...
                <span>
                  status:{" "}
                  <span>
                    <Tag color="#34bd7c">{product.status}</Tag>
                  </span>
                </span>
              </div>
        ...
        {/* <div className="product-description">
          ...
          <div className="product-desc-card">
            ...
            <p>
              ...
              animi, id est laborum et dolorum fuga. Et harum quidem rerum
              facilis est et expedita distinctio. Nam libero tempore, cum soluta
              nobis est eligendi optio cumque nihil maiores alias consequatur
              aut perferendis doloribus asperiores repellat <br />
              <br />
