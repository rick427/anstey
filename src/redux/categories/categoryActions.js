...
import {GET_CATEGORIES_REQUEST, GET_CATEGORIES_SUCCESS, GET_CATEGORIES_FAILED, CLIENT_ERROR, CREATE_CATEGORIES_REQUEST, CREATE_CATEGORIES_SUCCESS, CREATE_CATEGORIES_FAILED, DELETE_CATEGORY_REQUEST, DELETE_CATEGORY_SUCCESS, DELETE_CATEGORY_FAILED, GET_CATEGORY_BY_ID_REQUEST, GET_CATEGORY_BY_ID_SUCCESS, GET_CATEGORY_BY_ID_FAILED, EDIT_CATEGORY_REQUEST, EDIT_CATEGORY_SUCCESS, EDIT_CATEGORY_FAILED } from "../types";
...
export const editCategories = (data) => async dispatch => {
    ...
    try {
        ...
        const res = await axios.put(`${UrlService.EDIT_CATEGORY}/${data.id}`, data,  config);
...
export const getCategoryById = (id) => async dispatch => {
    ...
    try {
        ...
        const res = await axios.get(`${UrlService.GET_CATEGORY_BY_ID}/${id}`, config);
...
export const deleteCategory = (id) => async dispatch => {
    ...
    try {
        ...
        const res = await axios.delete(`${UrlService.DELETE_CATEGORY}/${id}`, config);
